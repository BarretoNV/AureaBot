...
module.exports = {
    ...
    execute (message, args) {
        ...
        .addFields(
            ...
            { name: 'Porcentagem alcançada:', value: (worksheets.Planilha1[2].Projetos).toFixed(2) , inline: true },
            ...
            { name: 'Porcentagem alcançada:', value: (worksheets.Planilha1[2].Faturamento).toFixed(2) , inline: true },
            ...
            { name: 'Porcentagem alcançada:', value: (worksheets.Planilha1[2].Acoes_compartilhadas).toFixed(2) , inline: true },
            { name: 'NPS:', value: worksheets.Planilha1[1].NPS , inline: true },
            { name: 'Meta:', value: worksheets.Planilha1[0].NPS , inline: true },
            { name: 'Porcentagem alcançada:', value: (worksheets.Planilha1[2].NPS).toFixed(2) , inline: true },
            ...
            { name: 'Porcentagem alcançada:', value: (worksheets.Planilha1[2].Membros_que_executam).toFixed(2) , inline: true },
            ...
            { name: 'Porcentagem alcançada:', value: (worksheets.Planilha1[2].Participacao_em_eventos).toFixed(2) , inline: true },
            ...
            { name: 'Porcentagem alcançada:', value: (worksheets.Planilha1[2].Projetos_de_impacto).toFixed(2) , inline: true },
        )
